...
from src.config import RESULTS_COMBINED, REPORTS_DIR, DASHBOARD_HTML
...
def generate_dashboard(data):
    ...
    for r in valid:
        ...
        ev = r.get("evaluation", {})
        b64_origin = img_to_base64(REPORTS_DIR / f"origin_{sid}.jpg")
        b64_temporal = img_to_base64(REPORTS_DIR / f"temporal_{sid}.jpg")
...
def main():
    ...
    size_kb = DASHBOARD_HTML.stat().st_size / 1024
